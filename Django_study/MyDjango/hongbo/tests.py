...
if opts.addrepo:
    ...
    for url in opts.addrepo:
        ...
        if url.endswith('.repo'):  # this is a .repo file - fetch it, put it in our reposdir and enable it
            ...
            grabber = repo.grabfunc;
            del repo

            print
            'grabbing file %s to %s' % (url, destname)
